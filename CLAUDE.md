...
helm lint ingress-nginx cert-manager-clusterissuer tailscale-operator syesite-chart hello-world
...
2. Add `<chart-name>` to `chart-dirs` in `.github/workflows/ci-fast.yml` and `ci-pr.yml`
